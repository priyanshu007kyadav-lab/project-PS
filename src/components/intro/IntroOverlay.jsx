...
import { triggerAutoStarTunnel } from "./IntroStar3D";

const FULL_TEXT = `Just one small thing before we begin...

I don't know if I'll get another chance in the future to wish you on your birthday or not.
So... I made a small gift for you from my side.

I know it isn't perfect, and you deserve more special gifts.
But I'm still learning, and every little part of this was made to bring a smile to your face.

Just one request...
Please stay until the very end. ❤️`;
...
export default function IntroOverlay() {
  ...
  useEffect(() => {
    if (scene !== STORY.INTRO || dismissed) return;
  ...
  if (scene !== STORY.INTRO || dismissed) return null;
  ...
  return (
    ...
    >
      {/* Floating Ultra-Translucent Apple iOS Liquid Glass Card */}
      <div
        style={{
          position: "relative",
          pointerEvents: "auto",
      ...
      >
        ...
        {/* Pure Liquid Glass Begin / Skip Button */}
        <button
          style={{
            position: "relative",
            zIndex: 2,
          ...
          onClick={() => {
            if (!isDone) {
              ...
              setDismissed(true);
              triggerAutoStarTunnel(500); // 0.5s auto-launch tunnel sequence
            }
          }}
        >
          {isDone ? "Begin 💫" : "Skip ⏩"}
